"""Tests for the ``monteur preview`` CLI — the thin render_preview wrapper.
...
render runs against the demo footage (skipped when it is missing) so the
wrapper is proven end-to-end at least once.
"""
...
from monteur.cli import build_parser, cmd_preview, main
